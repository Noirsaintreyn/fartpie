...
def engineer_level_features_for_lstm(
    ...
    # Separate by scale (check both 'scale' for unmerged and 'scales_detected' for merged levels)
    micro_levels = [l for l in multiscale_levels if 'micro' in l.get('scales_detected', [l.get('scale', '')])]
    meso_levels = [l for l in multiscale_levels if 'meso' in l.get('scales_detected', [l.get('scale', '')])]
    macro_levels = [l for l in multiscale_levels if 'macro' in l.get('scales_detected', [l.get('scale', '')])]
